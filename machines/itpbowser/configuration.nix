...
in {
  ...
  clan.core.networking.targetHost = "lcnbr@130.92.184.194";

  security.sudo.execWheelOnly = true;
  networking.hostName = "itpbowser";
  networking.hostId = "0d465fcd";
  networking.interfaces.enp7s0.ipv4.addresses = [
    {
      address = "130.92.184.194";
      prefixLength = 24;
    }
  ];
  ...
  disko.devices.disk.main.device = "/dev/disk/by-id/wwn-0x55cd2e41503ecdad";
